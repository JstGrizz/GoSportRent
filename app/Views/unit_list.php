                                ...
                                <div class="col-md-4">
                                    <div class="card card-custom shadow-sm">
                                        <div class="card-body text-center" style="padding: 20px;">
                                            ...
                                            <p class="card-text mb-1">Cost per Day: Rp. <?= esc(number_format($unit['cost_rent_per_day'], 0, ',', '.')); ?>
                                            </p>
                                            <p class="card-text mb-3">Cost per Month: Rp.
                                                <?= esc(number_format($unit['cost_rent_per_month'], 0, ',', '.')); ?></p>
